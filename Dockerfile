...
RUN	curl -H "Cache-Control: no-cache" https://rawgit.com/shikhir-arora/Nadecker/master/nadeko_installer_2_22_0.sh -o ./nadeko_installer.sh && chmod 755 nadeko_installer.sh && ./nadeko_installer.sh
RUN	curl -O -H "Cache-Control: no-cache" https://rawgit.com/shikhir-arora/Nadecker/master/nadeko_autorestart.sh && chmod 755 nadeko_autorestart.sh
